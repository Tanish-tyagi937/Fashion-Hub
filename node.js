...
app.post('/register', upload,async (req, res) => {
    let result = await newuser.findOne({email:req.body.email});
    if(result){
        ...
        data();
         ...
         req.flash("msg",'paasword and confirm password should be same');
...
app.post("/contactmail",(req,res)=>{
    ...
    var mailOptions = {
        from: req.body.email,
        to: 'tanish.tyagi98134@gmail.com',
    ...
    transporter.sendMail(mailOptions, (err) => {
        if (err) {
            ...
            console.log("sent");
            req.flash("msg","We will contact you as soon as possible......")
...
// key id ="rzp_test_bUU4KFxJb2bxmk"
// secret key = "qmzqC6EOreCHGM3HvTqnW5s2"

const instance = new Razorpay({
    key_id:"rzp_test_bUU4KFxJb2bxmk",
    key_secret:"qmzqC6EOreCHGM3HvTqnW5s2"
})
